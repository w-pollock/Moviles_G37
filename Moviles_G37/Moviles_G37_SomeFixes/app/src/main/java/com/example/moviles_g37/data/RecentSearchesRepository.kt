...
/**
 * Persists the user's most recent searches in Firestore under
 * users/{uid}/recentSearches. Older entries are pruned to keep the list short.
 */
class RecentSearchesRepository {
    ...
    /**
     * Adds a search. If the query already exists, its timestamp is updated
